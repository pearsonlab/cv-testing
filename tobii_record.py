...
def eject():
    print get_request('/api/system/eject')

def status():
    print get_request('/api/system/status')

def identify():
    print get_request('/api/identify')
...
if __name__ == "__main__":
    ...
    try:
        ...
        menu = int(raw_input("Enter 1 to calibrate and record\nEnter 2 to record as an existing user\nEnter 3 to eject card\nEnter 4 to print system status\nEnter any other number to quit\n"))
        if menu==1:
            ...
            project_id = int(raw_input('Please enter project id: '))
